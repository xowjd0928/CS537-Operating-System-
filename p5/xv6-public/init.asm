 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 b0 10 00 00 	movzbl 0x10b0(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 58 10 00 00 	jmp    *0x1058(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 50 10 00 00       	mov    $0x1050,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 08 30 00 00       	mov    0x3008,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 08 30 00 00    	mov    %edx,0x3008
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 08 30 00 00    	mov    %edx,0x3008
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 08 30 00 00    	mov    0x3008,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 08 30 00 00    	mov    0x3008,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 08 30 00 00    	mov    0x3008,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 08 30 00 00    	mov    %edx,0x3008
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 08 30 00 00 0c 	movl   $0x300c,0x3008
 7b7:	30 00 00 
    base.s.size = 0;
 7ba:	bf 0c 30 00 00       	mov    $0x300c,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 0c 30 00 00 0c 	movl   $0x300c,0x300c
 7c6:	30 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 10 30 00 00 00 	movl   $0x0,0x3010
 7d2:	00 00 00 
    if(p->s.size >= nunits){
