 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 98 10 00 00 	movzbl 0x1098(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 40 10 00 00 	jmp    *0x1040(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 38 10 00 00       	mov    $0x1038,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 00 32 00 00       	mov    0x3200,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 00 32 00 00    	mov    %edx,0x3200
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 00 32 00 00    	mov    %edx,0x3200
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 00 32 00 00    	mov    0x3200,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 00 32 00 00    	mov    0x3200,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 00 32 00 00    	mov    0x3200,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 00 32 00 00    	mov    %edx,0x3200
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 00 32 00 00 04 	movl   $0x3204,0x3200
 7d7:	32 00 00 
    base.s.size = 0;
 7da:	bf 04 32 00 00       	mov    $0x3204,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 04 32 00 00 04 	movl   $0x3204,0x3204
 7e6:	32 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 08 32 00 00 00 	movl   $0x0,0x3208
 7f2:	00 00 00 
    if(p->s.size >= nunits){
