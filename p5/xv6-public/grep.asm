 ...
 69c:	89 d1                	mov    %edx,%ecx
{
 ...
 6c9:	0f b6 92 98 10 00 00 	movzbl 0x1098(%edx),%edx
 ...
 749:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b9:	ff 24 85 40 10 00 00 	jmp    *0x1040(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8c7:	90                   	nop
          s = "(null)";
 8c8:	ba 36 10 00 00       	mov    $0x1036,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e1:	a1 00 34 00 00       	mov    0x3400,%eax
{
 ...
 921:	5b                   	pop    %ebx
  freep = p;
 922:	89 15 00 34 00 00    	mov    %edx,0x3400
}
 928:	5e                   	pop    %esi
 929:	5f                   	pop    %edi
 92a:	5d                   	pop    %ebp
 ...
 959:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 95c:	89 15 00 34 00 00    	mov    %edx,0x3400
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 3d 00 34 00 00    	mov    0x3400,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 4f                	jae    a10 <malloc+0xa0>
    ...
    if(p == freep)
 9c1:	8b 3d 00 34 00 00    	mov    0x3400,%edi
 ...
 9ea:	e8 f1 fe ff ff       	call   8e0 <free>
  return freep;
 9ef:	8b 15 00 34 00 00    	mov    0x3400,%edx
 ...
 a1c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a1f:	89 15 00 34 00 00    	mov    %edx,0x3400
}
 ...
 a2f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 00 34 00 00 04 	movl   $0x3404,0x3400
 a37:	34 00 00 
    base.s.size = 0;
 a3a:	bf 04 34 00 00       	mov    $0x3404,%edi
    base.s.ptr = freep = prevp = &base;
 a3f:	c7 05 04 34 00 00 04 	movl   $0x3404,0x3404
 a46:	34 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a49:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a4b:	c7 05 08 34 00 00 00 	movl   $0x0,0x3408
 a52:	00 00 00 
    if(p->s.size >= nunits){
