...
loaduvm(pde_t *pgdir, char *addr, struct inode *ip, uint offset, uint sz, uint flags)
{
    ...
    // Determine the permissions based on ELF flags
    int perm = PTE_U;  // All user pages get PTE_U (user-accessible)
    ...
    for(i = 0; i < sz; i += PGSIZE){
        ...
        // Update PTE by clearing existing flags and applying the new permissions
