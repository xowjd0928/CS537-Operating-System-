 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 4d9:	0f b6 92 98 10 00 00 	movzbl 0x1098(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c9:	ff 24 85 40 10 00 00 	jmp    *0x1040(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba 37 10 00 00       	mov    $0x1037,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 00 32 00 00       	mov    0x3200,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 00 32 00 00    	mov    %edx,0x3200
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 00 32 00 00    	mov    %edx,0x3200
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d 00 32 00 00    	mov    0x3200,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d 00 32 00 00    	mov    0x3200,%edi
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 00 32 00 00    	mov    0x3200,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 00 32 00 00    	mov    %edx,0x3200
}
 ...
 83f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 00 32 00 00 04 	movl   $0x3204,0x3200
 847:	32 00 00 
    base.s.size = 0;
 84a:	bf 04 32 00 00       	mov    $0x3204,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 04 32 00 00 04 	movl   $0x3204,0x3204
 856:	32 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 85b:	c7 05 08 32 00 00 00 	movl   $0x0,0x3208
 862:	00 00 00 
    if(p->s.size >= nunits){
