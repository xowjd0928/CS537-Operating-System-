 ...
 66c:	89 d1                	mov    %edx,%ecx
{
 ...
 699:	0f b6 92 ac 10 00 00 	movzbl 0x10ac(%edx),%edx
 ...
 719:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 789:	ff 24 85 54 10 00 00 	jmp    *0x1054(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 897:	90                   	nop
          s = "(null)";
 898:	ba 4a 10 00 00       	mov    $0x104a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8b1:	a1 10 30 00 00       	mov    0x3010,%eax
{
 ...
 8f1:	5b                   	pop    %ebx
  freep = p;
 8f2:	89 15 10 30 00 00    	mov    %edx,0x3010
}
 8f8:	5e                   	pop    %esi
 8f9:	5f                   	pop    %edi
 8fa:	5d                   	pop    %ebp
 ...
 929:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 92c:	89 15 10 30 00 00    	mov    %edx,0x3010
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 949:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 94c:	8b 3d 10 30 00 00    	mov    0x3010,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 98f:	73 4f                	jae    9e0 <malloc+0xa0>
    ...
    if(p == freep)
 991:	8b 3d 10 30 00 00    	mov    0x3010,%edi
 ...
 9ba:	e8 f1 fe ff ff       	call   8b0 <free>
  return freep;
 9bf:	8b 15 10 30 00 00    	mov    0x3010,%edx
 ...
 9ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ef:	89 15 10 30 00 00    	mov    %edx,0x3010
}
 ...
 9ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a00:	c7 05 10 30 00 00 14 	movl   $0x3014,0x3010
 a07:	30 00 00 
    base.s.size = 0;
 a0a:	bf 14 30 00 00       	mov    $0x3014,%edi
    base.s.ptr = freep = prevp = &base;
 a0f:	c7 05 14 30 00 00 14 	movl   $0x3014,0x3014
 a16:	30 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a19:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a1b:	c7 05 18 30 00 00 00 	movl   $0x0,0x3018
 a22:	00 00 00 
    if(p->s.size >= nunits){
