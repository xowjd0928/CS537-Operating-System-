    ...
    39ac:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    39d9:	0f b6 92 f8 57 00 00 	movzbl 0x57f8(%edx),%edx
    ...
    3a59:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ac9:	ff 24 85 a0 57 00 00 	jmp    *0x57a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3bd7:	90                   	nop
          s = "(null)";
    3bd8:	ba 96 57 00 00       	mov    $0x5796,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bf1:	a1 c0 c7 00 00       	mov    0xc7c0,%eax
{
  ...
  freep = p;
    ...
    3c31:	5b                   	pop    %ebx
  freep = p;
    3c32:	89 15 c0 c7 00 00    	mov    %edx,0xc7c0
}
    3c38:	5e                   	pop    %esi
    3c39:	5f                   	pop    %edi
    3c3a:	5d                   	pop    %ebp
  ...
  freep = p;
    3c6c:	89 15 c0 c7 00 00    	mov    %edx,0xc7c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c8c:	8b 3d c0 c7 00 00    	mov    0xc7c0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3cd1:	8b 3d c0 c7 00 00    	mov    0xc7c0,%edi
  ...
  return freep;
    3cff:	8b 15 c0 c7 00 00    	mov    0xc7c0,%edx
    ...
    3d2c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d2f:	89 15 c0 c7 00 00    	mov    %edx,0xc7c0
}
    ...
    3d3f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3d40:	c7 05 c0 c7 00 00 c4 	movl   $0xc7c4,0xc7c0
    3d47:	c7 00 00 
    base.s.size = 0;
    3d4a:	bf c4 c7 00 00       	mov    $0xc7c4,%edi
    base.s.ptr = freep = prevp = &base;
    3d4f:	c7 05 c4 c7 00 00 c4 	movl   $0xc7c4,0xc7c4
    3d56:	c7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d59:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3d5b:	c7 05 c8 c7 00 00 00 	movl   $0x0,0xc7c8
    3d62:	00 00 00 
    if(p->s.size >= nunits){
