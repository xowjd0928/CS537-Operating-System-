...
// ====================================================================
// TEST_9
// Summary: MAP+LAZY: Checks for lazy allocation in anon mapping
// ====================================================================
...
int main() {
    ...
    va_exists(map + PGSIZE * 2, FALSE); // third page is NOT allocated
    printf(1, "INFO: Third page is not allocated. \tOkay.\n");
